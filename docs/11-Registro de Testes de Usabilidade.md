...
| 2. Localizar a opção de login no menu principal.                    |
| 3. Preencher os campos de nome de usuário e senha.                   |
| 4. Clicar no botão "Login" para entrar na conta.                     |
| 5. Avaliar a facilidade de uso do processo de login.                 |
