    ...
    <>
      ...
      <FormContainer>
        <form action="" onSubmit={(event) => handleSubmit(event)}>
          ...
          <text style={{fontWeight:'bold', color:'#37266B', textAlign: 'center'}}> Olá, entre em sua conta Chatter!</text>
          <input
            type="text"
            placeholder="Usuario"
            name="username"
          ...
          <span style={{marginLeft: '5rem',}}> Não tem conta? <Link to="/register">Criar conta</Link></span>
        </form>
      </FormContainer>
      <ToastContainer />
    </>
